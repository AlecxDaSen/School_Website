...
<body>
        ...
        <swiper-container class="mySwiper" autoplay="true" speed="3000" loop="true" space-between="30" effect="fade">
            ...
            <swiper-slide>
                ...
                <div class="col-12 g_title text-center p-4">
                    <h2 class="text-white fw-bold mt-2 " style="font-size: 70px;">Clubs & Societies</h2>
    ...
    <div class="container-fluid " id="info">
        ...
        <!-- begin -->
         <div class="col-8 offset-2 text-center  mt-3 mb-3 " >
            <h4 class="text-black">Heading toward Clubs & Societies</h4>
