...
<body class="evtbody">
    ...
    <div class="col-12">
        <div class="col-12">
            ...
            <!-- Main Content -->
            <div class="container fade-in2" style="margin-top: 100px; margin-bottom: 25px;">
                <div class="row">
                    <!-- Welcome Text -->
                    <div class="col-md-6 mb-4">
                        <h2 class="fw-bold text-primary">Welcome to Our Events</h2>
                        <p class="text-muted">
                            Stay up to date with our latest parties and community events. We host some of the best nightlife gatherings and social activities in the city.
                        </p>
                        ...
                        <div class="list-group">
                            <a href="#" class="list-group-item list-group-item-action mb-2 rounded">
                                <div class="d-flex w-100 justify-content-between">
                                    <h5 class="mb-1">DJ Night Fever</h5>
                                    <small>30 August</small>
                                </div>
                                <p class="mb-1">An epic night with top DJs spinning RNB and Hip-Hop at Club X.</p>
                                <small>Click to view details</small>
                            </a>
                            <a href="#" class="list-group-item list-group-item-action mb-2 rounded">
                                <div class="d-flex w-100 justify-content-between">
                                    <h5 class="mb-1">Latin Vibes</h5>
                                    <small>26 August</small>
                                </div>
                                <p class="mb-1">Feel the rhythm with Latin dance performances and live music.</p>
                                <small>Click to view details</small>
                            </a>
                        </div>
                    </div>
                ...
                <div class="row mt-5 align-items-center">
                    ...
                    <div class="col-md-7">
                        <h3 class="fw-bold">Next Big Party: Best RNB from Europe</h3>
                        <p class="text-muted">
